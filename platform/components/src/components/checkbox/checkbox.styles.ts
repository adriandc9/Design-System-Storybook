...
/* input border */
.checkbox--item[data-user-invalid] .checkbox__input {
  border-color: var(--spk-checkbox-border-color-error);
}
/* item border */
.checkbox--item[data-user-invalid] {
  background-color: var(--spk-toggle-container-background-color-error);
  border-color: var(--spk-toggle-container-border-color-error);
}
...
.checkbox--required .checkbox__label::after {
  content: '*';
  color: var(--spk-checkbox-border-color-required);
}
`;
